(function (a) {
    a.fn.customSelectBox = function (b) {
        ...
        return this.each(function () {
            ...
            d.append('<span class="' + b.buttonClass + '">' + e + ' <span class="arrow">'+ b.arrow +'</span> </span><ul class="'+ b.itemsClass +'" style="display:none;"></ul>');
            f.each(function (l) {
                var k = a(this), m = k.val() ? k.val() : k.html(), h = k.html(),
                    j = k.is(":selected") ? b.selectedClass : k.is(":disabled") ? b.disabledClass : "";
                d.find("ul").append('<li class="' + j + " option-" + l + '" data-value="' + m + '">' + h + "</li>")
            });
